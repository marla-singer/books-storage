...
Template.bookPreview.events({
  'checked [name=set-reader]': function (event, templateInstance) {
      // Save reader to TI
  },
  'checked [name=set-rating]': function (event, templateInstance) {
      // Save rating to TI
  },
  'click #save-reader-info': function (event, templateInstance) {
        // Get book ID
